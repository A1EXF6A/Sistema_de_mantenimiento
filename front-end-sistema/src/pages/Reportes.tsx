...
const ReportesCombinados: React.FC = () => {
    ...
    // Cargar datos desde el caché (localStorage)
    useEffect(() => {
    ...
    const style = {
        ...
        buttonClear: { backgroundColor: '#FF6F61', color: '#fff', border: 'none', padding: '10px 15px', borderRadius: '5px', cursor: 'pointer', fontSize: '1rem' },
        toggleButton: { backgroundColor: '#4CAF50', color: '#fff', border: 'none', padding: '10px 15px', borderRadius: '5px', cursor: 'pointer', fontSize: '1rem' },
        section: { marginBottom: '30px' },
        buttonExport: { backgroundColor: '#007bff', color: '#fff', padding: '10px 15px', borderRadius: '5px', cursor: 'pointer', fontSize: '1rem', marginTop: '20px' }
    };
